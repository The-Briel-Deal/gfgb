; This is a simple test which disables and re-enables ch3 dac while a tone is
; being played. On disable, it should stop the tone, and on re-enable it should
; not resume playing until trigger is called again.
;
